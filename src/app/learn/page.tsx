      ...
      <div className="space-y-12 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/learn/rules" className="pixel-box pixel-box-yellow p-6 space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule1Desc}</p>
          ...
          <Link href="/learn/what-is-imposter" className="pixel-box pixel-box-cyan p-6 space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule2Desc}</p>
          ...
          <Link href="/learn/beginner-guide" className="pixel-box pixel-box-pink p-6 space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule3Desc}</p>
          ...
          <Link href="/learn/advanced-strategy" className="pixel-box p-6 border-2 border-[#10b981] dark:border-[#34d399] space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule4Desc}</p>
          ...
          <Link href="/learn/scoring-system" className="pixel-box p-6 border-2 border-[#ea580c] dark:border-[#fb923c] space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule5Desc}</p>
          ...
          <Link href="/learn/faq" className="pixel-box p-6 border-2 border-[#8b5cf6] dark:border-[#a78bfa] space-y-3">
            ...
            <p className="font-sans text-sm font-semibold text-slate-700 dark:text-slate-300">{dictionary.rule6Desc}</p>
