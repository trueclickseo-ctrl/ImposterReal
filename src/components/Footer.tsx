      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-arcade font-bold">
            ...
            <li><Link href="/company/careers/" className="text-[var(--text-secondary)] hover:text-[#ea580c] dark:hover:text-[#fb923c] font-semibold transition-colors">💼 Careers</Link></li>
            <li><Link href="/company/terms/" className="text-[var(--text-secondary)] hover:text-[#ea580c] dark:hover:text-[#fb923c] font-semibold transition-colors">⚖️ Terms of Service</Link></li>
          </ul>
        </div>
